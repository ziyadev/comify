  ...
  return (
    <div className="mx-auto max-w-4xl text-muted-foreground mb-16  md:pb-72 px-6">
      ...
      <p className="mb-4 text-sm md:text-xl leading-relaxed">
        ...
        ac lectus sem. Proin non nisl nec felis gravida bibendum in vel magna.
        Praesent in mi at est rhoncus finibus eu id quam. Integer lacinia, quam
      ...
      <p className="mb-4 text-sm md:text-xl leading-relaxed">
        ...
        venenatis. Nunc eu nulla vitae justo volutpat rhoncus. Donec eget odio
        at ipsum convallis euismod. Vivamus id justo non justo convallis dictum
        vel ut lorem.
      </p>
    </div>
  );
